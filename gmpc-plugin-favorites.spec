...
%define		source_name gmpc-favorites
Summary:	Favorites plugin for Gnome Music Player Client
Summary(pl.UTF-8):Wtyczka favorites dla odtwarzacza Gnome Music Player Client
Name:		gmpc-plugin-favorites
Version:	0.15.5.0
Release:	0.1
License:	GPL
...
# Source0-md5:	fb6b0343a2f95fab179db941bf5b750c
